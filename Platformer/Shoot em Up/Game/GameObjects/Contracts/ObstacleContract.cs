    ...
    class ObstacleContract 
    {
        ...
        public void Init()
        {
            ...
            for (int i = 0; i < NumberOfObjects; i++)
            {
                ...
                s.Add(new Obstacle(Hover, Animation, SpriteTileSize, new int[] {0}, 0, Density, Restitution, StaticFriction, KineticFriction, SpritePath, SpriteSize, new Vector2f(SpawnStartPosition[0], SpawnStartPosition[1]), 0, Health, Points, Damage, Game.factions[(int)Faction]));
                Game.spawners.Add(s);
            }
           // Game.spawners.Add(s);
        }
